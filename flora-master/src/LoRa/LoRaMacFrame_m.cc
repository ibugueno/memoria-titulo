...
void LoRaMacFrame::copy(const LoRaMacFrame& other)
{
    ...
    this->simSendNodeTime = other.simSendNodeTime;
...
void LoRaMacFrame::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->simSendNodeTime);
...
void LoRaMacFrame::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->simSendNodeTime);
...
::omnetpp::simtime_t LoRaMacFrame::getSimSendNodeTime() const
{
    return this->simSendNodeTime;
}

void LoRaMacFrame::setSimSendNodeTime(::omnetpp::simtime_t simSendNodeTime)
{
    this->simSendNodeTime = simSendNodeTime;
}
...
int LoRaMacFrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "simSendNodeTime")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "sequenceNumber")==0) return base+3;
    if (fieldName[0]=='L' && strcmp(fieldName, "LoRaTP")==0) return base+4;
    if (fieldName[0]=='L' && strcmp(fieldName, "LoRaCF")==0) return base+5;
    if (fieldName[0]=='L' && strcmp(fieldName, "LoRaSF")==0) return base+6;
    if (fieldName[0]=='L' && strcmp(fieldName, "LoRaBW")==0) return base+7;
    if (fieldName[0]=='L' && strcmp(fieldName, "LoRaCR")==0) return base+8;
    if (fieldName[0]=='L' && strcmp(fieldName, "LoRaUseHeader")==0) return base+9;
    if (fieldName[0]=='R' && strcmp(fieldName, "RSSI")==0) return base+10;
    if (fieldName[0]=='S' && strcmp(fieldName, "SNIR")==0) return base+11;
...
std::string LoRaMacFrameDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return simtime2string(pp->getSimSendNodeTime());
        case 3: return long2string(pp->getSequenceNumber());
        case 4: return double2string(pp->getLoRaTP());
        case 5: {std::stringstream out; out << pp->getLoRaCF(); return out.str();}
        case 6: return long2string(pp->getLoRaSF());
        case 7: {std::stringstream out; out << pp->getLoRaBW(); return out.str();}
        case 8: return long2string(pp->getLoRaCR());
        case 9: return bool2string(pp->getLoRaUseHeader());
        case 10: return double2string(pp->getRSSI());
        case 11: return double2string(pp->getSNIR());
        default: return "";
    }
}
...
bool LoRaMacFrameDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    LoRaMacFrame *pp = (LoRaMacFrame *)object; (void)pp;
    switch (field) {
        case 2: pp->setSimSendNodeTime(string2simtime(value)); return true;
        case 3: pp->setSequenceNumber(string2long(value)); return true;
        case 4: pp->setLoRaTP(string2double(value)); return true;
        case 6: pp->setLoRaSF(string2long(value)); return true;
        case 8: pp->setLoRaCR(string2long(value)); return true;
        case 9: pp->setLoRaUseHeader(string2bool(value)); return true;
        case 10: pp->setRSSI(string2double(value)); return true;
        case 11: pp->setSNIR(string2double(value)); return true;
...
const char *LoRaMacFrameDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case 7: return omnetpp::opp_typename(typeid(inet::units::values::Hz));
        default: return nullptr;
    };
}
...
void *LoRaMacFrameDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return (void *)(&pp->getLoRaCF()); break;
        case 7: return (void *)(&pp->getLoRaBW()); break;
        default: return nullptr;
    }
}
